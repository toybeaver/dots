...
#define BLACK_BLEND_THRESHOLD .01 // This is controls the dim of the screen
#define COLOR_SPEED 0.2          // This controls the speed at which the colors change
#define MOVEMENT_SPEED 0.5       // This controls the speed at which the balls move
