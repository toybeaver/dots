...
//Edits to transform to sakura: Jansen (jansen44)

#define SMOKE_INTENSITY_MULTIPLIER 0.0
#define PARTICLES_ALPHA_MOD 1.0
#define SMOKE_ALPHA_MOD 0.5
#define LAYERS_COUNT 6

#define BLACK_BLEND_THRESHOLD .01
...
#define MOVEMENT_SPEED .09
#define MOVEMENT_DIRECTION vec2(0.2, 1.0)

#define PARTICLE_SIZE 0.0030
...
#define SPARK_COLOR vec3(1.0, 0.8588235294117647, 0.8588235294117647) * 1.5
#define BLOOM_COLOR vec3(1.0, 0.6549019607843137, 0.6509803921568628) * 0.8
#define SMOKE_COLOR vec3(1.0, 0.43, 0.1) * 0.8

#define SIZE_MOD 1.25
