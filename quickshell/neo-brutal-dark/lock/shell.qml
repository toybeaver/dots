...
ShellRoot {
    ...
    // The card is a dark CONTAINER, not a block — the same call rofi makes.
    // It floats on a near-black desktop with nothing behind it, so its border
    // is the accent rather than ink, and its shadow a darker shade of that.
    readonly property color cBase:     "#0c0c0c"
    readonly property color cField:    "#17171a"
    readonly property color cText:     "#f2ede3"
    readonly property color cMuted:    "#8c877d"
    readonly property color cAccent:   "#9784d9"
    readonly property color cDanger:   "#ff5c5c"
    ...
    readonly property color cInk:      "#9784d9"
    readonly property color cShadow:   "#453b63"
    readonly property color cOnAccent: "#0c0c0c"
    ...
    WlSessionLock {
        ...
        WlSessionLockSurface {
            ...
            Rectangle {
                ...
                Image {
                    anchors.fill: parent
                    source: "file:///home/toyb/Pictures/wallpaper/brutal-dark.png"
