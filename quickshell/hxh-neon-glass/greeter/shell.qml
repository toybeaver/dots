...
ShellRoot {
    ...
    readonly property color cBase:   "#06080c"
    readonly property color cCard:   "#101319"
    readonly property color cField:  "#161a23"
    readonly property color cText:   "#edf1f7"
    readonly property color cMuted:  "#8b93a5"
    readonly property color cAccent: "#15fcfd"
    readonly property color cDanger: "#ff4060"
        ...
        PanelWindow {
            ...
            Rectangle {
                ...
                Rectangle {
                    anchors.fill: parent
                    gradient: Gradient {
                        GradientStop { position: 0.0; color: Qt.rgba(0.09, 0.11, 0.15, 0.55) }
                        GradientStop { position: 1.0; color: Qt.rgba(0.02, 0.03, 0.05, 0.92) }
                    }
                }
            }
                    ...
                    Column {
                        ...
                        Rectangle {
                            ...
                            TextInput {
                                ...
                                clip: true
                                selectByMouse: true
                                selectionColor: Qt.rgba(0.08, 0.99, 0.99, 0.35)
                        ...
                        Rectangle {
                            ...
                            height: 48
                            radius: 10
                            color: mouse.containsPress ? Qt.rgba(0.05, 0.75, 0.75, 1.0)
                                 : mouse.containsMouse ? root.cAccent
                                 : Qt.rgba(0.08, 0.99, 0.99, 0.88)
                    ...
                    Column {
                        ...
                        Repeater {
                            ...
                            Rectangle {
                                ...
                                width: menuCol.width
                                height: 34
                                color: itemMouse.containsMouse ? Qt.rgba(0.08, 0.99, 0.99, 0.16)
                                                               : "transparent"
