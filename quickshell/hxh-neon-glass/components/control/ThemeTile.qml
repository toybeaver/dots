...
ControlTile {
  ...
  // The rim goes cyan on the way out, matching the toggles' "this is a mode,
  // not a warning" idiom. The shell dies moments later, so this is mostly a
  // confirmation that the click registered at all.
  edgeColor: ThemeSwitcher.switching
